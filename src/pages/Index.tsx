...
const createInitialPresentation = (): Presentation => ({
  id: makeId(),
  title: 'Роберт Рождественский: «В каждой песне я вновь оживу...»',
  slides: [
    {
      id: makeId(),
      layout: 'title',
      title: 'Роберт Рождественский',
      subtitle: '«В каждой песне я вновь оживу...»',
      body: '',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
    {
      ...
      title: 'Вступление',
      subtitle: '',
      body: '«У настоящих поэтов есть только год рождения. Года смерти у настоящих поэтов нет».\n\nРоберт Рождественский — один из самых громких и светлых голосов эпохи «шестидесятников». Поэт, который разговаривал с огромной страной на языке искренности, и чьи стихи стали поистине народными песнями.',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
    {
      id: makeId(),
      layout: 'text',
      title: 'Судьба поэта: от детства с винтовкой до эстрады',
      subtitle: '1932–1950-е',
      body: 'Родился в 1932 году в алтайском селе Косиха. Детство закончилось 22 июня 1941-го: родители ушли на фронт, девятилетний мальчик пишет первое стихотворение «С винтовкой мой папа уходит в поход…» — его печатают в «Омской правде».\n\nПосле отказа в Литинституте («за отсутствием таланта») — поступил со второй попытки. Вскоре стал частью легендарной четвёрки: Рождественский, Вознесенский, Евтушенко, Ахмадулина. Они собирали стадионы и вернули поэзии роль рупора времени.',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
    {
      id: makeId(),
      layout: 'text',
      title: 'Поэзия совести',
      subtitle: 'О чём писал Рождественский',
      body: '• Память о войне. Поэма «Реквием» — плач по миллионам павших. Из шести братьев матери с фронта вернулся только один.\n\n• Быстротечность жизни. Из поэмы «210 шагов»:\n«Женщину, самую лучшую в мире, сделать счастливой не успеваю!.. А написать свои главные строки не успеваю! И вряд ли успею...»\n\n• Любовная лирика. Муза и единственная любовь — Алла Киреева. Беззащитность и нежность вместо громких фраз.',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
    {
      id: makeId(),
      layout: 'text',
      title: 'Поэт, который звучал в каждом доме',
      subtitle: 'Стихи, ставшие музыкой',
      body: 'Рождественский был уникально музыкален. Он сотрудничал с Пахмутовой, Таривердиевым, Тухмановым, Бабаджаняном — список гениев, писавших на его стихи, бесконечен.\n\n«Мгновения» (к/ф «Семнадцать мгновений весны», муз. Таривердиева) — философия целой жизни, уложенная в короткие музыкальные фразы.\n\nВ 2018 году казахстанский исполнитель «масло черного тмина» выпустил трек «Роберт Рождественский» в жанре дарк-джаз — и текст классика ожил в совершенно новом звучании.',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
    {
      ...
      title: 'Заключение',
      subtitle: '1932–1994',
      body: 'Он прожил 62 года: возглавил комиссию по наследию Высоцкого, издал первый сборник его стихов «Нерв», добился открытия музея Цветаевой и возвращения имени Мандельштама.\n\nРождественский ушёл в августе 1994-го, но года смерти у него нет.\n\n«Все начинается с любви», «Если вы есть — будьте первыми», «Желаю вам» — его строки стали народными афоризмами.\n\nКогда мы слышим знакомый мотив и подпеваем — Роберт Иванович снова оживает. В каждой песне.',
      imageUrl: '',
      bgColor: '#faf8f4',
      accentColor: '#a07850',
    },
